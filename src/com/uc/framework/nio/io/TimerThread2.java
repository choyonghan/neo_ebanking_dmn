...
{
	private static Logger	logger = Logger.getLogger(TimerThread2.class);
    ...
    private static TimerThread2 instance;
     ...
     * Singleton getter.
     */
    public static synchronized TimerThread2 getInstance()
    {
        if (instance == null) {
        	logger.info("getInstance time !!: 1");
            instance = new TimerThread2();
            instance.start();
        }
