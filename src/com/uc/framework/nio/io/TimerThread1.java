...
{
	private static Logger	logger = Logger.getLogger(TimerThread1.class);
    ...
    private static TimerThread1 instance;
     ...
     * Singleton getter.
     */
    public static synchronized TimerThread1 getInstance()
    {
        if (instance == null) {
        	logger.info("getInstance time !!: 1");
            instance = new TimerThread1();
            instance.start();
        }
