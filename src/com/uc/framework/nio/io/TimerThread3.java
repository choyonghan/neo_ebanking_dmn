...
{
	private static Logger	logger = Logger.getLogger(TimerThread3.class);
    ...
    private static TimerThread3 instance;
     ...
     * Singleton getter.
     */
    public static synchronized TimerThread3 getInstance()
    {
        if (instance == null) {
        	logger.info("getInstance time !!: 1");
            instance = new TimerThread3();
            instance.start();
        }
