...
public class Etmd_WorkField_E {
	 ...
	 * 생성자
	 */
	public Etmd_WorkField_E() {

		headField = new FieldList_e();

		headField.add("MessageLength"        ,  4 , "H");
		headField.add("TrDateTime"           , 14 , "C");
		headField.add("FILL"                 ,  4 , "C");
		headField.add("MessageType"          ,  4 , "C");
		headField.add("MessageDesc"          ,  2 , "C");
		headField.add("MessageRequestCode"   ,  4 , "C");
		headField.add("TXSEQ"                , 14 , "C");
		headField.add("UpcheReq"             , 10 , "C");
		headField.add("Errcode"              ,  4 , "C");
		...
		headField.add("업체역영", 4,    "C");    // 예비-position(60)
		headField.add("예비", 5,    "C");    // 예비-position(60)
